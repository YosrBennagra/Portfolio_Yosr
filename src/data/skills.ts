...
export const skills: Skill[] = [
  ...
  { name: 'Python/Flask', category: 'backend', level: 94 },
  { name: 'ASP.NET Core', category: 'backend', level: 80 },
  ...
  { name: 'SonarQube', category: 'tools', level: 92 },
  { name: 'Grafana', category: 'tools', level: 90 },
  { name: 'Prometheus', category: 'tools', level: 90 },
  ...
  { name: 'RAG', category: 'tools', level: 75 }
];
