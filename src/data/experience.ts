...
export const experiences: Experience[] = [
  {
    ...
    highlights: {
      en: [
        ...
        'Work directly with the client; review code and mentor 4 junior developers in 2-week Agile sprints.'
      ],
      fr: [
        ...
        'Travail direct avec le client ; revue de code et mentorat de 4 développeurs juniors dans des sprints Agile de 2 semaines.'
      ]
    },
    type: 'work'
  },
  {
    ...
    description: {
      en: 'ESPRIT, Software Engineering Degree, 2020–2025.',
      fr: "ESPRIT – Diplôme d'ingénierie logicielle, 2020–2025."
    },
    highlights: {
      en: [
        'Software engineering studies at ESPRIT, 2020–2025, alongside part-time work at WICO Technology.'
      ],
      fr: [
        "Études d'ingénierie logicielle à ESPRIT, 2020–2025, en parallèle d'un temps partiel chez WICO Technology."
      ]
    },
    type: 'education'
  }
