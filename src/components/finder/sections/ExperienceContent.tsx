...
import { ChevronDown, CheckCircle2, Calendar, MapPin } from 'lucide-react';
...
export default function ExperienceContent({ onSelectItem, selectedId }: ExperienceContentProps) {
                ...
                return (
                    ...
                    >
                        ...
                        >
                            {/* Logo */}
                            {exp.logo && (
                                <div className="w-10 h-10 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-white/10 overflow-hidden flex-shrink-0 flex items-center justify-center">
                                    <Image
                                        src={exp.logo}
