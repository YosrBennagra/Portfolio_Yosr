                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <motion.button
                                ...
                                className="p-4 rounded-xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 text-left hover:bg-slate-50 dark:hover:bg-white/10 transition-all group shadow-sm dark:shadow-none"
                            >
                                ...
                                <p className="text-sm font-medium text-slate-800 dark:text-white truncate">{emailAddress}</p>
                            ...
                            <motion.button
                                ...
                                className="p-4 rounded-xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 text-left hover:bg-slate-50 dark:hover:bg-white/10 transition-all shadow-sm dark:shadow-none"
                            >
                                ...
                                <p className="text-sm font-medium text-slate-800 dark:text-white">{displayPhoneNumber}</p>
                            ...
                            >
                                ...
                                <p className="text-sm font-medium text-slate-800 dark:text-white">Quick Chat</p>
                            ...
                            >
                                ...
                                <p className="text-sm font-medium text-slate-800 dark:text-white">Connect</p>
                                <p className="text-[10px] text-blue-500 dark:text-blue-400 mt-1">View profile →</p>
                            </motion.a>
                        </div>

                        {/* Social Links Row */}
                        <div className="p-4 rounded-xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 shadow-sm dark:shadow-none">
                            <p className="text-xs text-slate-500 dark:text-white/50 mb-3">More ways to connect</p>
                                ...
                                {socialLinks.map((social) => {
                                    ...
                                    return (
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="flex items-center gap-2 px-3 py-2 rounded-lg bg-slate-50 dark:bg-white/5 text-slate-600 dark:text-white/70 hover:bg-slate-100 dark:hover:bg-white/10 hover:text-slate-800 dark:hover:text-white transition-all text-xs"
                                        >
